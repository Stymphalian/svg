...
return function(canvas,T){
    ...
    var l1 = canvas.polygon("25,25 150,25 150,150").attr(a).style.fill("green");    
    var l3 = canvas.polygon([35,35,160,35,160,160]).attr(a).style.fill("red");
    var l2 = canvas.polygon("30,30,155,30,155,155").attr(a).style.fill("blue");
